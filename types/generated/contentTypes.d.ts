...
export interface ApiCertificateCertificate extends Schema.CollectionType {
  ...
  attributes: {
    uniqueId: Attribute.String & Attribute.Required & Attribute.Unique;
...
export interface ApiProgramProgram extends Schema.CollectionType {
  ...
  attributes: {
    ...
    certificateStatus: Attribute.Enumeration<['Not Ready', 'Ready']> &
      Attribute.Required &
...
export interface ApiStudentStudent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    submittedOn: Attribute.DateTime & Attribute.Required;
    certificateStatus: Attribute.Enumeration<
      ['Not Generated', 'Generated', 'Downloaded']
    > &
      Attribute.Required &
      Attribute.DefaultTo<'Not Generated'>;
    program: Attribute.Relation<
      'api::student.student',
      'manyToOne',
      'api::program.program'
